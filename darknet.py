...
if __name__ == "__main__":
    ...
    #print r[:10]
    net = load_net(b"/home/idt-china/darknet/cfg/yolov3.cfg", b"/home/idt-china/darknet/yolov3.weights", 0)
    meta = load_meta(b"/home/idt-china/darknet/cfg/coco.data")
    origin_img = "/home/idt-china/darknet/data/test1.jpg"
    out_img = "/home/idt-china/darknet/data/test_result8.jpg"
    r, rlist = detect(net, meta, origin_img)
    print("I am here. r:", type(r), len(r), r)
    print("I am here. rlist:", type(rlist), len(rlist), rlist)
    showPicResult(origin_img)
    apply_heatmap(origin_img, rlist)
